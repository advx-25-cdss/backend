...
async def get_medicines(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error retrieving medicines: {str(e)}")
...
async def get_medicines_by_patient(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error retrieving patient medicines: {str(e)}")
...
async def get_medicines_by_case(case_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error retrieving case medicines: {str(e)}")
...
async def discontinue_medicine(medicine_id: str, end_date: Optional[datetime] = None):
    ...
    try:
        ...
        updated_medicine = await medicine_service.update(medicine_id, {"end_date": end_date})
        return {"message": "Medicine discontinued successfully", "data": updated_medicine}
    except HTTPException:
        raise
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Error discontinuing medicine: {str(e)}")
...
async def reactivate_medicine(medicine_id: str):
    ...
    try:
        ...
        updated_medicine = await medicine_service.update(medicine_id, {"end_date": None})
        return {"message": "Medicine reactivated successfully", "data": updated_medicine}
    except HTTPException:
        raise
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Error reactivating medicine: {str(e)}")
